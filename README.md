...
> macOS builds are not yet notarized, so macOS blocks the app one time. On first launch, click **Done**, then go to **System Settings → Privacy & Security**, scroll to Security, and click **Open Anyway**.
